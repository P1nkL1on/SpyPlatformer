class movement{
	...
	static function become_humanoid_mover (who:MovieClip){
		...
		who.roll_timer = 0; who.roll_cd = 0;
	}
	...
	static function being_humanoid_mover (who:MovieClip) : Boolean{
			...
			if (human.is_alive (who) && who.spirit){
					if (who.roll_timer != 0 )who.want_crounch = true;
					...
					if (who.ground)
						who.sp_x = ((who.roll_timer != 0)? who.roll_timer / 4.5: who.side) 	// roll speed here!!!
						...
						{ if (who.rolling_timer != 0 && Math.abs(who.sp_x) > who.walking_speed_max * 1.25) who.sp_x /= 1.5; 
					...
					// roll mode
					if (who.want_crounch && who.want_jump && who.roll_timer == 0 && who.roll_cd <= 0)
						{ who.roll_timer = ((who.view_x - who._x > 0)*2 - 1) * 35; who.roll_cd = 40;}
					if (who.roll_timer != 0) who.roll_timer += ((who.roll_timer > 0)? -1 : 1) * who.ground;	// descrease timer
